...
/*Napisati program kojim se od k duži u ravni koje su zadate koordinatama svojih krajnjih tačaka,
 *  izdvaja ona čije je središte na najkradem rastojanju od koordinatnog početka.*/
import java.io.*;
...
public class Primer19 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 2; i <= k; i++) {
			...
			// Nalaženje duži čije je središte na najkradem rastojanju od koordinatnog
			// početka
